...
<template>
  <div class="apply-approval common-table">
    ...
    <el-collapse class="common-collapse common-fold" v-model="currentCollapse">
      <el-collapse-item name="1" class="active">
        ...
        >
          ...
          <el-table-column prop="borrowDate" label="归还
          日期" show-overflow-tooltip></el-table-column>
        </el-table>
    ...
    <el-row>
      ...
      <el-col :span="24">
        <el-input class="mb10" v-model.trim="formData.remark" width="100%" type="textarea" disabled></el-input>
      </el-col>
    </el-row>
    ...
    <el-row v-if="!finish">
      <el-col :span="24">
        <el-input v-model.trim="approvalOpinion" maxlength="100" resize="none" width="100%" type="textarea" :disabled="disabled"></el-input>
...
export default {
  ...
  methods: {
    ...
    getApprovalData() {
      ...
      axiosGet("process/returnProcessForm/getApproval?applicationNum=" + applicationNum).then(result => {
        if (result.code == 200) {
          this.formData = result.data.returnProcessForm;
    ...
    sendPost(params) {
      ...
      axiosPost("process/returnProcessForm/passOrReject", params).then(result => {
