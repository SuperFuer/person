      ...
      <el-collapse class="common-collapse" v-model="currentCollapse">
        <el-collapse-item name="1" class="active">
          ...
          >
            ...
            <el-table-column prop="equipNum" label="资产编码" width="100"></el-table-column>
            ...
            <el-table-column prop="specification" label="原安装地点" width="200"></el-table-column>
            <el-table-column prop="manufacturNum" label="原使用人"></el-table-column>
            <el-table-column prop="purchasePrice" label="所属部门"></el-table-column>
            <el-table-column prop="locationCode" label="位置编码"></el-table-column>
            <el-table-column prop="locationName" label="位置名称"></el-table-column>
            <el-table-column prop="installLocDesc" label="现安装地点" width="200"></el-table-column>
            <el-table-column prop="usingMan" label="现使用人"></el-table-column>
