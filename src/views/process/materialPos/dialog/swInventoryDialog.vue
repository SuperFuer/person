<!--
 * @Description: 资产闲置申请页面=>新增数据弹框页面
 * @Version:
 * @Autor: louisyi
 * @Date: 2019-08-27 18:36:09
 * @LastEditors: louisyi
 * @LastEditTime: 2019-09-10 20:40:15
 -->
<template>
  <div class="swInventoryDialog">
...
<script>
import { getEquipList, getDialogInitData, getDeptAll, getDeptUser } from '@/api/swApi.js'
...
export default {
  ...
  methods: {
    ...
    getEquipList () {
      ...
      getEquipList(this.searchInput).then((res) => {
        if (res.code === 200) {
