...
<template>
  <div class="unsealing-page">
    <div class="form-title">
      <i class="icon"></i>实物资产启封申请
    </div>
      ...
      <el-collapse class="common-collapse" v-model="currentCollapse">
        <el-collapse-item name="1" class="active">
          ...
          >
            ...
            <!-- <el-table-column :show-overflow-tooltip="true" prop="assetNum" label="资产编码"></el-table-column> -->
            ...
            <el-table-column
              ...
              prop="archiveTime"
            ></el-table-column>
            <el-table-column :show-overflow-tooltip="true" label="启封日期" width="170px">
              <template slot-scope="scope">
                <el-date-picker
                  :disabled="callFlag"
                  v-model="scope.row.unarchiveTime"
                  type="date"
                  placeholder="选择日期"
                  :clearable="false"
                  :editable="false"
            ...
            <el-table-column label="安装地点" width="140px">
              <template slot-scope="scope">
                <el-input
                  :disabled="callFlag"
                  v-model.trim="scope.row.installSite"
                  class="setInput"
                  maxlength="20"
                ></el-input>
              </template>
          ...
          <div class="common-pagination">
            <el-pagination
              ...
              ref="pagination"
            ></el-pagination>
            <div class="have-choice">已选择：{{selectNum}}</div>
          </div>
        </el-collapse-item>
      </el-collapse>
      ...
      <div class="seal-query">
        <el-form :inline="true" label-width="80px">
          ...
          <el-form-item label="使用人" label-width="80px">
            <!-- <el-input v-model="userQuery"></el-input> -->
            <el-input
              style="width:202px;"
              v-model="userQuery"
              @focus="setRenDatas"
        ...
        >
          ...
          <!-- <el-table-column prop="assetNum" label="资产编码"></el-table-column> -->
          <el-table-column :show-overflow-tooltip="true" prop="equipNum" label="设备编码"></el-table-column>
          <el-table-column :show-overflow-tooltip="true" prop="equipName" label="设备名称"></el-table-column>
          <el-table-column :show-overflow-tooltip="true" prop="equipState" label="设备状态"></el-table-column>
          <el-table-column :show-overflow-tooltip="true" prop="useMan" label="使用人"></el-table-column>
          <el-table-column :show-overflow-tooltip="true" prop="useDept" label="使用人部门" width="100px"></el-table-column>
          <el-table-column :show-overflow-tooltip="true" prop="belongModule" label="所属模块"></el-table-column>
        ...
        <div class="common-pagination">
          ...
          ></el-pagination>
          <div class="have-choice">已选择：{{popNumber}}</div>
        </div>
...
export default {
  ...
  methods: {
    ...
    handlePaginationChange(val) {
      ...
      console.log(this.currentPage, '分页分页');
        ...
        if (valid) {
          ...
          if (_this.sealDetailList.length > 0 && flag) {
            nullArr = _this.sealDetailList.find(item => {
              return !item.installSite;
            });
          }
          if (flag && nullArr && nullArr.installSite == "") {
            _this.messageTip("安装地点不能为空！");
            return;
          }
          // 全部必填信息完成
    ...
    getInitData() {
      var _this = this;
      // 初始化页面
      axiosGet("archive/init-form?type=0", { showLoading: true }).then(
        result => {
          if (result.code == 200) {
