      ...
      <el-collapse class="common-collapse" v-model="currentCollapse">
        <el-collapse-item name="1" class="active">
          ...
          >
            ...
            <el-table-column :show-overflow-tooltip="true" label="序号" width="60" type="index"></el-table-column>
            <!-- <el-table-column prop="assetNum" label="资产编码" width="100"></el-table-column> -->
            <el-table-column :show-overflow-tooltip="true" prop="equipNum" label="设备编码" width="130"></el-table-column>
            <el-table-column
            ...
            <el-table-column
                ...
                width="100"
            ></el-table-column>
            <el-table-column prop="positionCode" label="位置编码" width="140">
            ...
            <el-table-column
                ...
                width="160"
            ></el-table-column>
            <el-table-column label="现安装地点" width="140">
              <template slot-scope="scope">
                <el-input
                    v-model="scope.row.nowInstallLocDesc"
            ...
            <el-table-column label="现使用人" width="140">
              <template slot-scope="scope">
                <el-select
                    v-model="scope.row.nowUsingMan"
                    filterable
                    :disabled="callFlag"
                    @change="changepeoSelect($event,scope.$index)"
                    placeholder="请选择"
                >
                  <el-option
        ...
        <div class="query-title">批量导入</div>
        <el-row>
          <el-col>
...
<!--              :on-exceed="handleTemplateExceed"-->
              <el-upload
                  ...
                  :headers="headers"
                  accept=".xls"
                  :disabled="callFlag || tableData.length>0"
                  :auto-upload="false"
              >
                <el-button
                    slot="trigger"
...
<!--              </template>-->
      ...
      <el-form-item class="btn-group" v-if="!isHistory">
        <el-button
    ...
    <!-- 变更模块业务经理 -->
    <el-dialog title="选择变更模块经理" :visible.sync="innerVisible" width="75%">
      <!-- <el-row :gutter="20">
        <el-col :span="8">
    ...
    <el-dialog title="添加设备" top="1vh" append-to-body :visible.sync="equipDialog" width="70%" class="add-Equip">
      <equipment-query @getEquipList="getEquipList"></equipment-query>
    </el-dialog>
  </div>
</template>
<script>
...
import equipmentQuery from "../process/materialPos/sbChange/equipmentQuery";
